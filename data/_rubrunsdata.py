...
'''
import _rubrunsdata
_rubrunsdata.rubruns[3]['DE']['description']
'Villas, Ferienwohnungen, Stadth&auml;user and spanisch H&auml;user zwischen &euro;200,000 und &euro; 300,000 preislich'
len(_rubrunsdata.rubruns)
51
def search(rubrun, rubruns):
  return [element for element in rubruns if element['rubrun'] == rubrun]

thisrubrun = search('2-3',_rubrunsdata.rubruns)
thisrubrun[0]['DE']['description']
'Villas, Ferienwohnungen, Stadth&auml;user and spanisch H&auml;user zwischen &euro;200,000 und &euro; 300,000 preislich'
>>> thisrubrun[0]['DE']['keywords']
'''
